...
hurl invoke conference conference_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- conference org1
# Install to your blockchain - From the root of your project
hurl install conference node -P ./chaincode-conference
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install conference node -P ./chaincode-conference --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade conference node 1.2 -P ./chaincode-conference
```
